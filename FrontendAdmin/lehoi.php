        ...
        switch($action) {
            case 'add':
                ...
                $data = [
                    ...
                    'slug' => '', // sẽ tự động sinh trong model
                    'mo_ta' => $_POST['mo_ta'] ?? '',
    ...
    <div class="modal-content">
        ...
        <form method="POST" id="editForm" enctype="multipart/form-data" onsubmit="console.log('Form submitting...', document.getElementById('edit_ma_le_hoi').value); return true;">
            ...
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    <label>Mô tả</label>
                    <textarea name="mo_ta" id="edit_mo_ta" rows="6"></textarea>
                </div>
                <div class="form-group full-width">
                    <label>Ảnh đại diện</label>
